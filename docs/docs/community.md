...
- :computer: **GitHub**
    ...
    Open-source projects, CLI issues, and the Humanbound Firewall repository.

    [:octicons-link-external-16: GitHub](https://github.com/Humanbound)
...
- :email: **Support**
    ...
    Contact the team directly at support@humanbound.ai for enterprise inquiries.

    [:octicons-link-external-16: Email Support](mailto:support@humanbound.ai)
